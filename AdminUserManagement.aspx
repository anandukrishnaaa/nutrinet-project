<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminUserManagement.aspx.cs" Inherits="AdminUserManagement" %>
        ...
        <span class="display-5 mb-3 d-block">User Management Panel</span>
            <div class="row align-items-center">
                ...
                <div class="col ms-auto ">
                    <asp:Label ID="lblUsr" runat="server" Text="No. Of Registered Users : " />    
                    <asp:Label ID="lblUsrCount" runat="server" Text=""></asp:Label>                                        
                </div>
            </div>
            <div class="my-3 ms-1">
            ...
            <asp:GridView ID="grdUsr" runat="server" CssClass="table table-bordered table-hover"
                ...
                <Columns>
                    <asp:BoundField DataField="UDB_Id" HeaderText="Employee ID" ReadOnly="True" SortExpression="UDB_Id" />
                    <asp:BoundField DataField="UDB_Name" HeaderText="Employee Name" SortExpression="UDB_Name"
                        HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                    <asp:BoundField DataField="UDB_Address" HeaderText="Employee Address" SortExpression="UDB_Address"
